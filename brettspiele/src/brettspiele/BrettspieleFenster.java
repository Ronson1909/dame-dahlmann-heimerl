...
public class BrettspieleFenster extends JFrame implements ZugBeendetListener<IZug>, ComponentListener {
	...
	AbstractAction foa = new AbstractAction() {
		...
		{
			super.putValue(NAME, "�ffnen...");			
			super.putValue(SHORT_DESCRIPTION, "�ffnet einen Spielstand");			
		...
		public void actionPerformed(ActionEvent e) {
			...
			od.setDialogTitle("Spielstand �ffnen...");
		    ...
		    if (returnVal == JFileChooser.APPROVE_OPTION) {
		    	if (sd.getSelectedFile().exists()) {
		    		int response = JOptionPane.showConfirmDialog (null,
		    				"Wollen Sie die vorhandene Datei wirklich �berschreiben?","�berschreiben",
	...
	AbstractAction uma = new AbstractAction() {
...

		{
			...
			super.putValue(NAME, "Zug r�ckg�ngig");			
			super.putValue(SHORT_DESCRIPTION, "Macht den letzten Zug r�ckg�ngig");			
	...
	AbstractAction rma = new AbstractAction() {
...

		{
			...
			super.putValue(SHORT_DESCRIPTION, "Stellt den letzten r�ckg�ngig gemachten Zug wieder her");			
