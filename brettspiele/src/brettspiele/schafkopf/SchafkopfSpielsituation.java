...
public class SchafkopfSpielsituation implements ISpielsituation {
	...
	private ArrayList<Integer> spielerMitSpielabsichtInt; //nur f�r interne Verwendung
	...
	/**
	 * Gibt die Karten des aktuellen Spielers zur�ck.
	...
	/**
	 * Gibt den aktuellen Stich zur�ck.
	...
	/**
	 * Gibt die bisherigen Stiche der Spieler zur�ck.
	 * @param spieler Der Index des Spielers, dessen Stiche zur�ckgegeben werden sollen.
	...
	/**
	 * Gibt den Index des Spielers zur�ck, der diese Runde ausgeteilt hat.
	...
	/**
	 * Gibt den Index des Spielers zur�ck, der bei diesem Stich ausgespielt hat. 
	...
	public void spielenJaNein(boolean ja) throws Exception {
		if (status != Status.WARTE_AUF_SPIELEN_JA_NEIN)
			throw new Exception("Falscher Status f�r spielenJaNein!");
	...
	public void waehleSpielart(Spielartwahl zug) throws Exception {
		if (status != Status.WARTE_AUF_SPIELARTWAHL)
			throw new Exception("Falscher Status f�r die Spielartwahl!");
	 ...
	 * @param zug Die Information �ber eine auszuspielende Karte.
	 */
	public void ausspielen(Ausspielvorgang zug) throws Exception {
		if (status != Status.WARTE_AUF_AUSSPIELEN)
			throw new Exception("Falscher Status f�r den Ausspielvorgang!");
	...
	public void bestaetigeStich(Stichbestaetigung sb) throws Exception {
		if (status != Status.WARTE_AUF_STICHBESTAETIGUNG)
			throw new Exception("Falscher Status f�r Stichbest�tigung!");
	...
	/**
	 * Gibt die Farbe einer Spielkarte zur�ck.
	...
	/**
	 * Gibt die Punktzahl einer Spielkarte zur�ck.
	 * @param sp Die Spielkarte, dessen Punktzahl zur�ckgegeben werden soll.
	...
	/**
	 * Gibt f�r eine Spielkarte das entsprechende Bild/Symbol/Zahl zur�ck.
	 * @param sp Die Spielkarte, f�r die das Bild zur�ckgegeben werden soll.
	...
	/**
	 * Gibt den Index des Spielers zur�ck, der am Zug ist.
	...
	/**
	 * Gibt das aktuell gespielte Spiel zur�ck.
